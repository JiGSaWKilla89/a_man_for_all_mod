...
init 1:#Mod Defaults
    ...
    define gui.jg_mod_version = '0.4'
    define gui.mod_update_version = 1
    define gui.dev_mod_page = "a_man_for_all_mod"
    define gui.mod_update_date = "22/10/2024"
    ...
    define gui.developer_name = "Venus Waltz"
    define gui.developer_support = "https://www.patreon.com/venuswaltz"
    default mod_changelog = read_changelog()
    default mod_updated = "None", gui.jg_mod_version
    default jgs_develop = False

    define gui.current_episode = 15
