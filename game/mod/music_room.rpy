...
define mmtrack = AudioCredits(
    "Main Menu",
    "Main Menu Track",
    "audio/titles/mainmenu_short.ogg",
    unlocked=True
    )
define apartmentmusic = AudioCredits(
    "MC Apartment",
    "Apartment",
    "audio/music/apartment_mc_001.ogg"
    )
define arcade_music = AudioCredits(
    "Arcade Music",
    "Arcade",
    "audio/music/arcade_001.ogg"
    )
define bar1_music = AudioCredits(
    "Bar Midtown Down",
    "Bar",
    "audio/music/bar_midtown_down_01.ogg"
    )
define bar2_music = AudioCredits(
    "Bar Midtown Open",
    "Bar",
    "audio/music/bar_midtown_open_01.ogg"
    )
define bar3_music = AudioCredits(
    "Bar Oldtown",
    "Bar",
    "audio/music/bar_oldtown_01.ogg"
    )
define basketball_music = AudioCredits(
    "Basketball",
    "Bar",
    "audio/music/basketball_001.ogg"
    )
define bigpete_music = AudioCredits(
    "Big Pete",
    "Big Pete",
    "audio/music/bigpete_01.ogg"
    )
define club1_music = AudioCredits(
    "Club 01",
    "Club",
    "audio/music/club_001.ogg"
    )
define club2_music = AudioCredits(
    "Club 02",
    "Club",
    "audio/music/club_002.ogg"
    )
define club3_music = AudioCredits(
    "Club 03",
    "Club",
    "audio/music/club_003.ogg"
    )
define club4_music = AudioCredits(
    "Club Oldtown",
    "Club",
    "audio/music/club_004_oldtown.ogg"
    )
define comedy_club_music = AudioCredits(
    "Comedy Club",
    "Club",
    "audio/music/club_comedy_001.ogg"
    )
define confession1_music = AudioCredits(
    "Confession 01",
    "Confession",
    "audio/music/confession_001.ogg"
    )
define confession2_music = AudioCredits(
    "Confession 2",
    "Confession",
    "audio/music/confession_002.ogg"
    )
define dance1_music = AudioCredits(
    "Dance 01",
    "Dance",
    "audio/music/dance_001.ogg"
    )
define dance2_music = AudioCredits(
    "Dance 02",
    "Dance",
    "audio/music/dance_002.ogg"
    )
define dance3_music = AudioCredits(
    "Dance Slow 01",
    "Dance",
    "audio/music/dance_slow_001.ogg"
    )
define dance4_music = AudioCredits(
    "Dance Slow 02",
    "Dance",
    "audio/music/dance_slow_002.ogg"
    )
define dance5_music = AudioCredits(
    "Dance Waltz",
    "Dance",
    "audio/music/dance_waltz_001.ogg"
    )
define date1_music = AudioCredits(
    "Date Vanessa",
    "Date",
    "audio/music/date_001_vanessa.ogg"
    )
define date2_music = AudioCredits(
    "Date 2",
    "Date",
    "audio/music/date_002.ogg"
    )
define erika1_music = AudioCredits(
    "Erika 01",
    "Erika",
    "audio/music/erika_01.ogg"
    )
define erika2_music = AudioCredits(
    "Erika 02",
    "Erika",
    "audio/music/erika_02.ogg"
    )
define fashion1_music = AudioCredits(
    "Fashion 01",
    "Fashion",
    "audio/music/fashion_001.ogg"
    )
define fight1_music = AudioCredits(
    "Fight 01",
    "Fight",
    "audio/music/fight_01.ogg"
    )
define fight2_music = AudioCredits(
    "Fight 02",
    "Fight",
    "audio/music/fight_02.ogg"
    )
define fight3_music = AudioCredits(
    "Fight 03",
    "Fight",
    "audio/music/fight_03.ogg"
    )
define gymoldtown_music = AudioCredits(
    "Gym Oldtown",
    "Gym",
    "audio/music/gym_oldtown_01.ogg"
    )
define hangout1_music = AudioCredits(
    "Hangout 01",
    "Hangout",
    "audio/music/hangout_01.ogg"
    )
define hangout2_music = AudioCredits(
    "Hangout 02",
    "Hangout",
    "audio/music/hangout_02.ogg"
    )
define hangout3_music = AudioCredits(
    "Hangout 03",
    "Hangout",
    "audio/music/hangout_03.ogg"
    )
define harlow1_music = AudioCredits(
    "Harlow 01",
    "Harlow",
    "audio/music/harlow_01.ogg"
    )
define hmmm1_music = AudioCredits(
    "Hmmm 01",
    "Hmmm",
    "audio/music/hmmm_01.ogg"
    )
define hmmm2_music = AudioCredits(
    "Hmmm 02",
    "Hmmm",
    "audio/music/hmmm_02.ogg"
    )
define joke1_music = AudioCredits(
    "Joke 01",
    "Joke",
    "audio/music/joke_001.ogg"
    )
define kate1_music = AudioCredits(
    "Kate 01",
    "Kate",
    "audio/music/kate_01.ogg"
    )
define loss1_music = AudioCredits(
    "Loss 01",
    "Loss",
    "audio/music/loss_001.ogg"
    )
define lukedance_music = AudioCredits(
    "Luke Dance",
    "Dance",
    "audio/music/luke_dance_001.ogg"
    )
define midtown2_music = AudioCredits(
    "Midtown 02",
    "Midtown",
    "audio/music/midtown_002.ogg"
    )
define midtown1_music = AudioCredits(
    "Midtown 01",
    "Midtown",
    "audio/music/midtown_01.ogg"
    )
define momstheme_music = AudioCredits(
    "Mom's Theme",
    "Theme",
    "audio/music/moms_theme_01.ogg"
    )
define office1_music = AudioCredits(
    "Office Uptown",
    "Office",
    "audio/music/office_uptown_001.ogg"
    )
define oldtown1_music = AudioCredits(
    "Oldtown 01",
    "Oldtown",
    "audio/music/oldtown_01.ogg"
    )
define outro5_music = AudioCredits(
    "Outro 05",
    "Outro",
    "audio/music/outro_005.ogg"
    )
define outro2_music = AudioCredits(
    "Outro 02",
    "Outro",
    "audio/music/outro_02.ogg"
    )
define partyfb_music = AudioCredits(
    "Party Flashback",
    "Party",
    "audio/music/party_flashback_001.ogg"
    )
define partyhw1_music = AudioCredits(
    "Party Halloween 01",
    "Party",
    "audio/music/party_halloween_001.ogg"
    )
define partyhw2_music = AudioCredits(
    "Party Halloween 02",
    "Party",
    "audio/music/party_halloween_002.ogg"
    )
define partyhw3_music = AudioCredits(
    "Party Halloween 03",
    "Party",
    "audio/music/party_halloween_003.ogg"
    )
define partyhw4_music = AudioCredits(
    "Party Halloween 04",
    "Party",
    "audio/music/party_halloween_004.ogg"
    )
define pgground1_music = AudioCredits(
    "Proving Grounds 01",
    "Proving Grounds",
    "audio/music/pgrounds_01.ogg"
    )
define pinkrabbit_music = AudioCredits(
    "The Pink Rabbit",
    "Pink Rabbit",
    "audio/music/pinkrabbit001.ogg"
    )
define policetheme_music = AudioCredits(
    "Police Theme",
    "Police",
    "audio/music/police_theme_001.ogg"
    )
define private_music = AudioCredits(
    "Private Dance",
    "Dance",
    "audio/music/privatedance001.ogg"
    )
define rapbattle_music = AudioCredits(
    "Rap Battle",
    "Rap",
    "audio/music/rap_battle_001.ogg"
    )
define rapperform_music = AudioCredits(
    "Rap Perform",
    "Rap",
    "audio/music/rap_perform_001.ogg"
    )
define riley1_music = AudioCredits(
    "Riley 01",
    "Riley",
    "audio/music/riley_01.ogg"
    )
define sexy1_music = AudioCredits(
    "Sexy 01",
    "Sexy",
    "audio/music/sexy_001.ogg"
    )
define sexy2_music = AudioCredits(
    "Sexy 02",
    "Sexy",
    "audio/music/sexy_002.ogg"
    )
define sexy3_music = AudioCredits(
    "Sexy 03",
    "Sexy",
    "audio/music/sexy_003.ogg"
    )
define sexy4_music = AudioCredits(
    "Sexy 04",
    "Sexy",
    "audio/music/sexy_004.ogg"
    )
define sexy5_music = AudioCredits(
    "Sexy 05",
    "Sexy",
    "audio/music/sexy_005.ogg"
    )
define sexy6_music = AudioCredits(
    "Sexy 06",
    "Sexy",
    "audio/music/sexy_006.ogg"
    )
define sexy7_music = AudioCredits(
    "Sexy 07",
    "Sexy",
    "audio/music/sexy_007.ogg"
    )
define sexy8_music = AudioCredits(
    "Sexy 08",
    "Sexy",
    "audio/music/sexy_008.ogg"
    )
define sexy9_music = AudioCredits(
    "Sexy 09",
    "Sexy",
    "audio/music/sexy_009.ogg"
    )
define sexy10_music = AudioCredits(
    "Sexy 010",
    "Sexy",
    "audio/music/sexy_010.ogg"
    )
define sexy11_music = AudioCredits(
    "Sexy 011",
    "Sexy",
    "audio/music/sexy_011.ogg"
    )
define sexy_music = AudioCredits(
    "Sexy 012",
    "Sexy",
    "audio/music/sexy_012.ogg"
    )
define sexy13_music = AudioCredits(
    "Sexy 013",
    "Sexy",
    "audio/music/sexy_013.ogg"
    )
define sexy14_music = AudioCredits(
    "Sexy 014",
    "Sexy",
    "audio/music/sexy_014.ogg"
    )
define barclayfight_music = AudioCredits(
    "Barclay Theme",
    "Fight",
    "audio/music/theme_fighter_barclay_001.ogg"
    )
define chargerfight_music = AudioCredits(
    "Charger Theme",
    "Fight",
    "audio/music/theme_fighter_charger_001.ogg"
    )
define creepfight_music = AudioCredits(
    "Creep Theme",
    "Creep",
    "audio/music/theme_fighter_creep_001.ogg"
    )
define cyborgfight_music = AudioCredits(
    "Cyborg Theme",
    "Fight",
    "audio/music/theme_fighter_cyborg_001.ogg"
    )
define diablofight_music = AudioCredits(
    "Diablo Theme",
    "Fight",
    "audio/music/theme_fighter_diablo_001.ogg"
    )
define heatfight_music = AudioCredits(
    "Heat Theme",
    "Fight",
    "audio/music/theme_fighter_heat_001.ogg"
    )
define loverboyfight_music = AudioCredits(
    "Loverboy Theme",
    "Fight",
    "audio/music/theme_fighter_loverboy_001.ogg"
    )
define mtgfight_music = AudioCredits(
    "MTG Theme",
    "Fight",
    "audio/music/theme_fighter_mtg_001.ogg"
    )
define wardenfight_music = AudioCredits(
    "Warden Theme",
    "Fight",
    "audio/music/theme_fighter_warden_001.ogg"
    )
define reynoldsfight_music = AudioCredits(
    "Reynolds Theme",
    "Fight",
    "audio/music/theme_rt_reynolds_001.ogg"
    )
define tutorial_music = AudioCredits(
    "Tutorial Theme",
    "Tutorial",
    "audio/music/tutorial.ogg"
    )
define uptown1_music = AudioCredits(
    "Uptown 01",
    "Uptown",
    "audio/music/uptown_01.ogg"
    )
define uptown2_music = AudioCredits(
    "Uptown 02",
    "Uptown",
    "audio/music/uptown_02.ogg"
    )
define uptown3_music = AudioCredits(
    "Uptown 03",
    "Uptown",
    "audio/music/uptown_03.ogg"
    )
define vanessa1_music = AudioCredits(
    "Vanessa 01",
    "Vanessa",
    "audio/music/vanessa_01.ogg"
    )
define viridian1_music = AudioCredits(
    "Viridian 01",
    "Viridian",
    "audio/music/viridian_001.ogg"
    )
define viridian2_music = AudioCredits(
    "Viridian 02",
    "Viridian",
    "audio/music/viridian_002.ogg"
    )
define viridian3_music = AudioCredits(
    "Viridian 03",
    "Viridian",
    "audio/music/viridian_003.ogg"
    )
define wakeup1_music = AudioCredits(
    "Wake Up 01",
    "Wake Up",
    "audio/music/wakeup_01.ogg"
    )
define wakeup2_music = AudioCredits(
    "Wake Up 02",
    "Wake Up",
    "audio/music/wakeup_02.ogg"
    )
define walk1_music = AudioCredits(
    "Walk 01",
    "Walk",
    "audio/music/walk_001.ogg"
    )
define outros01_music = AudioCredits(
    "Outros 01",
    "Outros",
    "audio/outros/outro01.ogg"
    )
define outros02_music = AudioCredits(
    "Outros 02",
    "Outros",
    "audio/outros/outro_001.ogg"
    )
define outros03_music = AudioCredits(
    "Outros 03",
    "Outros",
    "audio/outros/outro_002.ogg"
    )
define outros04_music = AudioCredits(
    "Outros 04",
    "Outros",
    "audio/outros/outro_003.ogg"
    )
define outros05_music = AudioCredits(
    "Outros 05",
    "Outros",
    "audio/outros/outro_004.ogg"
    )
define outros06_music = AudioCredits(
    "Outros 06",
    "Outros",
    "audio/outros/outro_006.ogg"
    )
define outros07_music = AudioCredits(
    "Outros 07",
    "Outros",
    "audio/outros/outro_007.ogg"
    )
define outros08_music = AudioCredits(
    "Outros 08",
    "Outros",
    "audio/outros/outro_008.ogg"
    )
define outros09_music = AudioCredits(
    "Outros 09",
    "Outros",
    "audio/outros/outro_009.ogg"
    )
define outros010_music = AudioCredits(
    "Outros 010",
    "Outros",
    "audio/outros/outro_010.ogg"
    )
define outros011_music = AudioCredits(
    "Outros 011",
    "Outros",
    "audio/outros/outro_011.ogg"
    )
define outros012_music = AudioCredits(
    "Outros 012",
    "Outros",
    "audio/outros/outro_012.ogg"
    )
...
init -1000 python:
    ...
    def music_pos(style_name, size, yalign, st, at):
        ...
        if renpy.music.is_playing("music"):
            if renpy.music.get_pos("music") is not None:
                time_position = renpy.music.get_pos("music") or time_position
        else:
            time_position = 0.0
    ...
    def music_postt(style_name, size, st, at):
        ...
        global time_position
        if renpy.music.is_playing(get_playing_channels()):
            if renpy.music.get_pos(get_playing_channels()) is not None:
                time_position = renpy.music.get_pos(get_playing_channels()) or time_position
        else:
            time_position = 0.0
    ...
    def music_dur(style_name, size, yalign, st, at):
        ...
        if renpy.music.is_playing("music"):
            try:
                time_duration = get_music_len(mr.get_track("music"), False) or time_duration
            except:
                time_duration = renpy.music.get_duration(
                    "music") or time_duration
        else:
            time_duration = 0.0
    ...
    def music_durtt(style_name, size, st, at):
        ...
        if renpy.music.is_playing(get_playing_channels()):
            try:
                time_duration = get_music_len(mr.get_track(get_playing_channels()), False) or time_duration
            except:
                time_duration = renpy.music.get_duration(
                    get_playing_channels()) or time_duration
        else:
            time_duration = 0.0
    ...
    def musicroom_get_track(self,channel=None):
        ...
        if filename != None:
            if "<from" in filename:
                ...
                filename = renpy.music.get_playing(channel=channel)
    ...
    def prevcurnext(self,channel=None):
        channel = channel if channel else self.channel
        global music_tracks
        if self._current_track == self.get_track(channel):
            return
        playlist = self.unlocked_playlist()
        music_playing = self.get_track(channel) if renpy.music.is_playing(channel) else playlist[0]
    ...
    class GetMusicPlaying(Action):
        def __init__(self, channel="music"):
            global mr
            self.mr       = mr
            self.filename = self.mr.get_track(channel)
            self.previous = self.mr.previous_track
            self.next     = self.mr.next_track
            self.channel = channel

        def __call__(self):
            self.mr.Previous_Current_Next(self.channel)
            filename = self.mr.get_track(self.channel)

            if self.filename != filename:
                self.filename = self.mr.get_track(self.channel)
                renpy.restart_interaction()
    ...
    def get_playing_channels():
        channels = ['music', 'sound', 'voice', 'backgroundmusic']  # Add any custom channels if needed
        playing_channels = []
        current_channel = "music"

        for channel in channels:
            # Use renpy.audio.music.get_playing() to check if something is playing
            if renpy.audio.music.get_playing(channel) is not None:
                playing_channels.append(channel)
        if playing_channels:
            current_channel = playing_channels[0]
    ...
    def get_music_files_archive(ignore_list=ignore_list_music):
        ...
        for file in renpy.list_files():
            ...
            if not file in ignore_list:
                if file.endswith((".flac", ".mp3", ".ogg", "opus", ".wav")) and not file.startswith("audio/sounds/"):
                    print(file)
...
init 10 python:
    ...
    def find_music():
        ...
        def run_replacements(item):
            replacements = ("audio/", "music/", "titles/", "outros/")
